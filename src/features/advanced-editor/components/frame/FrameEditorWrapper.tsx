...
import { HorizontalMediaToolbar } from '../../../shared/components/HorizontalMediaToolbar/HorizontalMediaToolbar';
import { MenuItem } from '../../../shared/components/menu-item';
import { FloatingControl } from '../../../shared/components/FloatingControl/FloatingControl';
...
export const FrameEditorWrapper: React.FC<FrameEditorWrapperProps> = ({
  ...
  const { playerRef, activeIds, trackItemsMap } = useSharedStore();
  ...
  useEffect(() => {
    if (!stateManagerInitialized) {
      ...
      const { setState } = useSharedStore.getState();
