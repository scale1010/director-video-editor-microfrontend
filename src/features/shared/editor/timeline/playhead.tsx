	...
	return (
		...
		>
			<div
				...
				className="absolute top-0 h-4 w-2 -translate-x-1/2 transform bg-primary text-xs font-semibold text-primary-foreground"
			/>
			<div className="relative h-full">
				<div className="absolute top-0 h-full w-3 -translate-x-1/2 transform" />
				<div className="absolute top-0 h-full w-0.5 -translate-x-1/2 transform bg-primary/50" />
			</div>
		</div>
	);
};
