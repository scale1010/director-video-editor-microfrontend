...
const BasicText = ({
	...
	const onChangeFontFamily = async (font: ICompactFont) => {
		console.log('BasicText: onChangeFontFamily called with font:', font);
		console.log('BasicText: trackItem:', trackItem);
		
		const fontName = font.default.postScriptName;
		const fontUrl = font.default.url;
		
		console.log('BasicText: Loading font:', fontName, 'from URL:', fontUrl);
		...
		console.log('BasicText: Font loaded, updating state and dispatching changes');
		...
		console.log('BasicText: Font change completed');
	};
