...
const FontFamily = ({
	...
	const handleFontSelect = async (font: ICompactFont) => {
		console.log('FontFamily: handleFontSelect called with font:', font);
		console.log('FontFamily: trackItem from props:', trackItem);
		console.log('FontFamily: handleChangeFont function:', handleChangeFont);
		
		if (trackItem) {
			// Use the prop function that's passed down from BasicText
			console.log('FontFamily: Calling handleChangeFont with font:', font);
			handleChangeFont(font);
			setOpen(false); // Close the popover after selection
		} else {
			console.log('FontFamily: No trackItem found!');
		}
	};

	console.log('FontFamily: Rendering with props:', { handleChangeFont, fontFamilyDisplay, trackItem, compactFonts: compactFonts.length });
			...
			{isLargeScreen ? (
				<div className="relative w-32">
					<Popover open={open} onOpenChange={setOpen}>
						...
						<PopoverContent className="z-[200] w-80 p-0">
